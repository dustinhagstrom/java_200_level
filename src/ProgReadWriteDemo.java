...
public class ProgReadWriteDemo {
	...
	public static void main( String[] args ) {
		...
		ProgReadWriteDemo demo = new ProgReadWriteDemo();
	}
	...
	public ProgReadWriteDemo() {
		...
		try {
			...
			String outputFileName = inputFileName.substring( 0, inputFileName.length()-4 ) + "_out.txt"; 
