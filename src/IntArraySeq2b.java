...
/******************************************************************************
 * A IntArraySeq2b is a collection of integer numbers. The sequence can have a
 ...
 *       machine. The constructor, addAfter, addBefore, and concatenation
 ...
 *      Source Code for IntArraySeq2b class, from which this class was modeled 
 *      for integers, is available at 
...
public class IntArraySeq2b {
	// Invariant of the IntArraySeq2b class:
		...
		/**
		 * A method to generate an independent copy of a sequence.
		 * 
		 * @param - sequenceToCopy The IntArraySeq2b to copy.
		 * @precondition sequenceToCopy is an IntArraySeq2b that exists.
		 * @postcondition This is an exact copy of sequenceToCopy.
		 * @exception OutOfMemoryError Indicates insufficient memory for creating the
		 *                             clone.
		 **/
		public IntArraySeq2b(IntArraySeq2b sequenceToCopy) {
			// Create a new IntArraySeq2b that will be returned as the copy of the invoked
			// IntArraySeq2b.
			try {
				// Copy the instance variables of the invoked IntArraySeq2b and assign them to
				// this IntArraySeq2b.
				this.data = new int[sequenceToCopy.data.length];
				this.currentIndex = sequenceToCopy.currentIndex;
				this.manyItems = sequenceToCopy.manyItems;
				// Copy the information in the data instance variable (int[]) from the
				// invoked IntArraySeq2b to its copy.
				System.arraycopy(sequenceToCopy.data, 0, this.data, 0, this.manyItems);
			} // end try
			catch (OutOfMemoryError e) {
				throw new OutOfMemoryError("There is not enough memory available to copy this sequence!");
			} // end catch
		}// end IntArraySeq2b(IntArraySeq2b sequenceToCopy) method
		...
		// Overridden Java Methods -- equals(Object obj) and toString()
		/**
